...
class MongoMemoryServer extends events_1.EventEmitter {
    ...
    stop(runCleanup = true) {
        ...
        return (0, tslib_1.__awaiter)(this, void 0, void 0, function* () {
            ...
            this.debug(`stop: Stopping MongoDB server on port ${this._instanceInfo.port} with pid ${(_a = this._instanceInfo.instance.mongodProcess) === null || _a === void 0 ? void 0 : _a.pid}` // "undefined" would say more than ""
            );
