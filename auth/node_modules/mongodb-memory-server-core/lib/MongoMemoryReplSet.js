            ...
            try {
                ...
                try {
                    ...
                    if (typeof this._replSetOpts.auth === 'object') {
                        ...
                        (0, utils_1.assertion)(!(0, utils_1.isNullOrUndefined)(primary.instanceInfo), new Error('Primary dosnt have "instanceInfo" defined') // TODO: change to "InstanceInfoError"
                        );
